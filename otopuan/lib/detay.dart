                ...
                children: [
                  ...
                  InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Text("İncele",style: TextStyle(color: Colors.white),),
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            DocumentSnapshot doc = snapshot.data
                                .docs[index];
                            return sec=="puanlama"?oylayanlar(widget.oto, widget.model, widget.marka, doc["kullanici"],doc["ortalama"],doc["kisiPp"]):genel(doc["yolTutuş"], doc["sehirIci"],
